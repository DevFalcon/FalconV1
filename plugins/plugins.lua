...
local function list_all_plugins(only_enabled)
  ...
  local text = text..'\n\n '..nsum..'*| آݪمۘڵفٱټ آݪمۘثبټهَ ➰*\n\n '..nact..'*| آݪمۘڵفٱټ آݪمۘفعّٖݪه ✔️*\n\n '..nsum-nact..'*| آݪمۘڵفٱټ آݪمعّٖطَݪهَ ✖️*\n\n[ADVISOR](Telegram.Me/XxMTxX)'
  return text
end
...
local function enable_plugin( plugin_name )
  ...
  if plugin_exists(plugin_name) then
    ...
    return '*🚩| ـۧلاٰ ێۄﺟډ مۘڵفَِ بآسِمۘ* `['..plugin_name..']` '
  end
end
...
local function disable_plugin( name, chat )
  ...
  if not plugin_exists(name) then
    return '*🚩| ـۧلاٰ ێۄﺟډ مۘڵفَِ بآسِمۘ* `['..name..']`'
  end
  local k = plugin_enabled(name)
  -- Check if plugin is enabled
  if not k then
    return '*🚩| آݪمۘڵفَِ* `['..name..']` *غۧيړ مۘفَِعّٖـِﻝِ ✖️*'
  end
  -- Disable and reload
